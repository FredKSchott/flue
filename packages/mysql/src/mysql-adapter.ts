...
async function ensureTables(runner: MysqlRunner): Promise<void> {
	...
	const ddl = [
		...
		`CREATE TABLE IF NOT EXISTS flue_attachment_staging (stream_path VARCHAR(${MYSQL_CONVERSATION_STREAM_PATH_LIMIT}) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL, attachment_id VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL, filename TEXT, state VARCHAR(16) CHARACTER SET ascii COLLATE ascii_bin NOT NULL, submission_id VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin, staged_at BIGINT NOT NULL, PRIMARY KEY (stream_path, attachment_id)) ENGINE=InnoDB`,
